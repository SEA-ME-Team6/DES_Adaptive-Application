###########################################################################
## Makefile generated for component 'Perception'. 
## 
## Makefile     : Perception.mk
## Generated on : Fri Mar 01 10:44:45 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Perception.elf
...
START_DIR                 = $(MATLAB_WORKSPACE)/home/seame-workstation09/DES_Adaptive-Application/Perception
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Perception.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/shared/spc/src_ml/extern/include -I$(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include -I$(MATLAB_ROOT)/extern/include/multimedia -I$(MATLAB_ROOT)/toolbox/vision/include -I$(MATLAB_ROOT)/toolbox/vision/visionrt/export/include -I$(MATLAB_ROOT)/toolbox/vision/visionrt/export/include/visionrt -I$(START_DIR)/Perception_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_WORKSPACE)/home/seame-workstation09/Documents/MATLAB/SupportPackages/R2023b/toolbox/realtime/targets/raspi/include -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_STANDARD = -DMODEL=Perception -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = DAHostLib_rtw.c.o HostLib_MMFile.c.o HostLib_Multimedia.c.o svd_d_rt.c.o svd_helper_rt.c.o is_little_endian_rt.c.o Perception.cpp.o Perception_data.cpp.o MW_raspi_init.c.o MW_Pyserver_control.c.o linuxinitialize.cpp.o
...
%.c.o : $(START_DIR)/Perception_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/Perception_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/Perception_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.cpp.o : $(START_DIR)/Perception_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


Perception.cpp.o : $(START_DIR)/Perception_ert_rtw/Perception.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


Perception_data.cpp.o : $(START_DIR)/Perception_ert_rtw/Perception_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
