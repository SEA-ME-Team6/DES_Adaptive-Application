...
class SoATest final
{
 ...
 private:
  // Block signals
  B_SoATest_T SoATest_B;

  // Block states
  DW_SoATest_T SoATest_DW;
  ...
  int32_t SoATest_EventReceive_SendData(const double *data);
  bool SoATest_pop(Buffer_real_T *q, Msg_real_T *elementOut);
  int32_t SoATest_EventReceive_RecvData(double *data);
};

extern const SoATest::ConstB_SoATest_T SoATest_ConstB;// constant block i/o
