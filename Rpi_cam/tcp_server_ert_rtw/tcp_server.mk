###########################################################################
## Makefile generated for component 'tcp_server'. 
## 
## Makefile     : tcp_server.mk
## Generated on : Tue May 28 16:07:24 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/tcp_server.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/tcp_server.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_WORKSPACE)/home/seame-workstation09/Documents/MATLAB/SupportPackages/R2023b/toolbox/target/supportpackages/shared_linuxservices/include -I$(START_DIR)/tcp_server_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_WORKSPACE)/home/seame-workstation09/Documents/MATLAB/SupportPackages/R2023b/toolbox/realtime/targets/raspi/include -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_ = -DMAX_CONN_RASPI -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_CAN_BITRATE=500000 -DMW_CAN_ALLOWALLMSGS=1
...
DEFINES_STANDARD = -DMODEL=tcp_server -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(MATLAB_WORKSPACE)/home/seame-workstation09/Documents/MATLAB/SupportPackages/R2023b/toolbox/target/supportpackages/shared_linuxservices/src/TCPSendReceive/MW_TCPSendReceive.c $(START_DIR)/tcp_server_ert_rtw/tcp_server.c $(MATLAB_WORKSPACE)/home/seame-workstation09/Documents/MATLAB/SupportPackages/R2023b/toolbox/realtime/targets/raspi/src/MW_raspi_init.c $(MATLAB_WORKSPACE)/home/seame-workstation09/Documents/MATLAB/SupportPackages/R2023b/toolbox/realtime/targets/raspi/src/periphs/MW_Pyserver_control.c $(MATLAB_ROOT)/toolbox/target/codertarget/rtos/src/linuxinitialize.c

MAIN_SRC = $(START_DIR)/tcp_server_ert_rtw/ert_main.c
...
OBJS = MW_TCPSendReceive.c.o tcp_server.c.o MW_raspi_init.c.o MW_Pyserver_control.c.o linuxinitialize.c.o
...
%.c.o : $(START_DIR)/tcp_server_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/tcp_server_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/tcp_server_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/tcp_server_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


tcp_server.c.o : $(START_DIR)/tcp_server_ert_rtw/tcp_server.c
	$(CC) $(CFLAGS) -o "$@" "$<"
