...
static void cgxe_mdl_start(InstanceStruct_Y0B9WgMUpDX622CpoG0hQE *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_Y0B9WgMUpDX622CpoG0hQE
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_Y0B9WgMUpDX622CpoG0hQE
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_Y0B9WgMUpDX622CpoG0hQE
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_Y0B9WgMUpDX622CpoG0hQE
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_Y0B9WgMUpDX622CpoG0hQE
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_Y0B9WgMUpDX622CpoG0hQE
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_Y0B9WgMUpDX622CpoG0hQE
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_Y0B9WgMUpDX622CpoG0hQE
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  codertarget_raspi_internal_RaspiTCPSend *obj);
static void mw__internal__call__reset(InstanceStruct_Y0B9WgMUpDX622CpoG0hQE
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_Y0B9WgMUpDX622CpoG0hQE
  *moduleInstance, const emlrtStack *sp, real_T b_u0);
static const mxArray *emlrt_marshallOut(InstanceStruct_Y0B9WgMUpDX622CpoG0hQE
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_Y0B9WgMUpDX622CpoG0hQE *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_Y0B9WgMUpDX622CpoG0hQE
...
static void cgxe_mdl_set_sim_state(InstanceStruct_Y0B9WgMUpDX622CpoG0hQE
...
static uint8_T j_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_Y0B9WgMUpDX622CpoG0hQE
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_Y0B9WgMUpDX622CpoG0hQE(SimStruct *S, int_T tid)
{
  InstanceStruct_Y0B9WgMUpDX622CpoG0hQE *moduleInstance =
    (InstanceStruct_Y0B9WgMUpDX622CpoG0hQE *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_Y0B9WgMUpDX622CpoG0hQE(SimStruct *S)
{
  InstanceStruct_Y0B9WgMUpDX622CpoG0hQE *moduleInstance =
    (InstanceStruct_Y0B9WgMUpDX622CpoG0hQE *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_Y0B9WgMUpDX622CpoG0hQE(SimStruct *S, int_T tid)
{
  InstanceStruct_Y0B9WgMUpDX622CpoG0hQE *moduleInstance =
    (InstanceStruct_Y0B9WgMUpDX622CpoG0hQE *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_Y0B9WgMUpDX622CpoG0hQE(SimStruct *S)
{
  InstanceStruct_Y0B9WgMUpDX622CpoG0hQE *moduleInstance =
    (InstanceStruct_Y0B9WgMUpDX622CpoG0hQE *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_Y0B9WgMUpDX622CpoG0hQE(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_Y0B9WgMUpDX622CpoG0hQE *moduleInstance =
    (InstanceStruct_Y0B9WgMUpDX622CpoG0hQE *)cgxertGetRuntimeInstance(S);
...
static void setSimState_Y0B9WgMUpDX622CpoG0hQE(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_Y0B9WgMUpDX622CpoG0hQE *moduleInstance =
    (InstanceStruct_Y0B9WgMUpDX622CpoG0hQE *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_Y0B9WgMUpDX622CpoG0hQE(SimStruct *S)
{
  InstanceStruct_Y0B9WgMUpDX622CpoG0hQE *moduleInstance =
    (InstanceStruct_Y0B9WgMUpDX622CpoG0hQE *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_Y0B9WgMUpDX622CpoG0hQE(SimStruct *S)
{
  InstanceStruct_Y0B9WgMUpDX622CpoG0hQE *moduleInstance =
    (InstanceStruct_Y0B9WgMUpDX622CpoG0hQE *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_Y0B9WgMUpDX622CpoG0hQE(SimStruct *S)
{
  InstanceStruct_Y0B9WgMUpDX622CpoG0hQE *moduleInstance =
    (InstanceStruct_Y0B9WgMUpDX622CpoG0hQE *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_Y0B9WgMUpDX622CpoG0hQE(SimStruct *S)
{
  InstanceStruct_Y0B9WgMUpDX622CpoG0hQE *moduleInstance =
    (InstanceStruct_Y0B9WgMUpDX622CpoG0hQE *)calloc(1, sizeof
    (InstanceStruct_Y0B9WgMUpDX622CpoG0hQE));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_Y0B9WgMUpDX622CpoG0hQE);
  ssSetmdlInitializeConditions(S, mdlInitialize_Y0B9WgMUpDX622CpoG0hQE);
  ssSetmdlUpdate(S, mdlUpdate_Y0B9WgMUpDX622CpoG0hQE);
  ssSetmdlDerivatives(S, mdlDerivatives_Y0B9WgMUpDX622CpoG0hQE);
  ssSetmdlTerminate(S, mdlTerminate_Y0B9WgMUpDX622CpoG0hQE);
  ssSetmdlEnable(S, mdlEnable_Y0B9WgMUpDX622CpoG0hQE);
  ssSetmdlDisable(S, mdlDisable_Y0B9WgMUpDX622CpoG0hQE);
...
static void mdlProcessParameters_Y0B9WgMUpDX622CpoG0hQE(SimStruct *S)
{
}

void method_dispatcher_Y0B9WgMUpDX622CpoG0hQE(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_Y0B9WgMUpDX622CpoG0hQE(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_Y0B9WgMUpDX622CpoG0hQE(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_Y0B9WgMUpDX622CpoG0hQE(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_Y0B9WgMUpDX622CpoG0hQE(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: Y0B9WgMUpDX622CpoG0hQE.\n"
...
mxArray *cgxe_Y0B9WgMUpDX622CpoG0hQE_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_Y0B9WgMUpDX622CpoG0hQE_fallback_info(void)
{
