...
static void cgxe_mdl_start(InstanceStruct_KfxEnyUMbeaOYicAxfslDF *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_KfxEnyUMbeaOYicAxfslDF
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_KfxEnyUMbeaOYicAxfslDF
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_KfxEnyUMbeaOYicAxfslDF
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_KfxEnyUMbeaOYicAxfslDF
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_KfxEnyUMbeaOYicAxfslDF
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_KfxEnyUMbeaOYicAxfslDF
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_KfxEnyUMbeaOYicAxfslDF
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_KfxEnyUMbeaOYicAxfslDF
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  codertarget_raspi_internal_RaspiTCPSend *obj);
static void mw__internal__call__reset(InstanceStruct_KfxEnyUMbeaOYicAxfslDF
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_KfxEnyUMbeaOYicAxfslDF
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_KfxEnyUMbeaOYicAxfslDF
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_KfxEnyUMbeaOYicAxfslDF *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_KfxEnyUMbeaOYicAxfslDF
...
static void cgxe_mdl_set_sim_state(InstanceStruct_KfxEnyUMbeaOYicAxfslDF
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_KfxEnyUMbeaOYicAxfslDF
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_KfxEnyUMbeaOYicAxfslDF(SimStruct *S, int_T tid)
{
  InstanceStruct_KfxEnyUMbeaOYicAxfslDF *moduleInstance =
    (InstanceStruct_KfxEnyUMbeaOYicAxfslDF *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_KfxEnyUMbeaOYicAxfslDF(SimStruct *S)
{
  InstanceStruct_KfxEnyUMbeaOYicAxfslDF *moduleInstance =
    (InstanceStruct_KfxEnyUMbeaOYicAxfslDF *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_KfxEnyUMbeaOYicAxfslDF(SimStruct *S, int_T tid)
{
  InstanceStruct_KfxEnyUMbeaOYicAxfslDF *moduleInstance =
    (InstanceStruct_KfxEnyUMbeaOYicAxfslDF *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_KfxEnyUMbeaOYicAxfslDF(SimStruct *S)
{
  InstanceStruct_KfxEnyUMbeaOYicAxfslDF *moduleInstance =
    (InstanceStruct_KfxEnyUMbeaOYicAxfslDF *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_KfxEnyUMbeaOYicAxfslDF(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_KfxEnyUMbeaOYicAxfslDF *moduleInstance =
    (InstanceStruct_KfxEnyUMbeaOYicAxfslDF *)cgxertGetRuntimeInstance(S);
...
static void setSimState_KfxEnyUMbeaOYicAxfslDF(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_KfxEnyUMbeaOYicAxfslDF *moduleInstance =
    (InstanceStruct_KfxEnyUMbeaOYicAxfslDF *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_KfxEnyUMbeaOYicAxfslDF(SimStruct *S)
{
  InstanceStruct_KfxEnyUMbeaOYicAxfslDF *moduleInstance =
    (InstanceStruct_KfxEnyUMbeaOYicAxfslDF *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_KfxEnyUMbeaOYicAxfslDF(SimStruct *S)
{
  InstanceStruct_KfxEnyUMbeaOYicAxfslDF *moduleInstance =
    (InstanceStruct_KfxEnyUMbeaOYicAxfslDF *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_KfxEnyUMbeaOYicAxfslDF(SimStruct *S)
{
  InstanceStruct_KfxEnyUMbeaOYicAxfslDF *moduleInstance =
    (InstanceStruct_KfxEnyUMbeaOYicAxfslDF *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_KfxEnyUMbeaOYicAxfslDF(SimStruct *S)
{
  InstanceStruct_KfxEnyUMbeaOYicAxfslDF *moduleInstance =
    (InstanceStruct_KfxEnyUMbeaOYicAxfslDF *)calloc(1, sizeof
    (InstanceStruct_KfxEnyUMbeaOYicAxfslDF));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_KfxEnyUMbeaOYicAxfslDF);
  ssSetmdlInitializeConditions(S, mdlInitialize_KfxEnyUMbeaOYicAxfslDF);
  ssSetmdlUpdate(S, mdlUpdate_KfxEnyUMbeaOYicAxfslDF);
  ssSetmdlDerivatives(S, mdlDerivatives_KfxEnyUMbeaOYicAxfslDF);
  ssSetmdlTerminate(S, mdlTerminate_KfxEnyUMbeaOYicAxfslDF);
  ssSetmdlEnable(S, mdlEnable_KfxEnyUMbeaOYicAxfslDF);
  ssSetmdlDisable(S, mdlDisable_KfxEnyUMbeaOYicAxfslDF);
...
static void mdlProcessParameters_KfxEnyUMbeaOYicAxfslDF(SimStruct *S)
{
}

void method_dispatcher_KfxEnyUMbeaOYicAxfslDF(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_KfxEnyUMbeaOYicAxfslDF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_KfxEnyUMbeaOYicAxfslDF(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_KfxEnyUMbeaOYicAxfslDF(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_KfxEnyUMbeaOYicAxfslDF(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: KfxEnyUMbeaOYicAxfslDF.\n"
...
mxArray *cgxe_KfxEnyUMbeaOYicAxfslDF_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_KfxEnyUMbeaOYicAxfslDF_fallback_info(void)
{
