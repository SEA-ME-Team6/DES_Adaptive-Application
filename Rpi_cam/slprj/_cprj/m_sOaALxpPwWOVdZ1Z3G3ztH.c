...
static void cgxe_mdl_start(InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  codertarget_raspi_internal_RaspiTCPReceive *obj);
static void mw__internal__call__reset(InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH
  *moduleInstance, const emlrtStack *sp, uint8_T *c_y0, int8_T *c_y1);
static const mxArray *emlrt_marshallOut(InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH
...
static void cgxe_mdl_set_sim_state(InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_sOaALxpPwWOVdZ1Z3G3ztH(SimStruct *S, int_T tid)
{
  InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH *moduleInstance =
    (InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_sOaALxpPwWOVdZ1Z3G3ztH(SimStruct *S)
{
  InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH *moduleInstance =
    (InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_sOaALxpPwWOVdZ1Z3G3ztH(SimStruct *S, int_T tid)
{
  InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH *moduleInstance =
    (InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_sOaALxpPwWOVdZ1Z3G3ztH(SimStruct *S)
{
  InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH *moduleInstance =
    (InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_sOaALxpPwWOVdZ1Z3G3ztH(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH *moduleInstance =
    (InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH *)cgxertGetRuntimeInstance(S);
...
static void setSimState_sOaALxpPwWOVdZ1Z3G3ztH(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH *moduleInstance =
    (InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_sOaALxpPwWOVdZ1Z3G3ztH(SimStruct *S)
{
  InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH *moduleInstance =
    (InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_sOaALxpPwWOVdZ1Z3G3ztH(SimStruct *S)
{
  InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH *moduleInstance =
    (InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_sOaALxpPwWOVdZ1Z3G3ztH(SimStruct *S)
{
  InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH *moduleInstance =
    (InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_sOaALxpPwWOVdZ1Z3G3ztH(SimStruct *S)
{
  InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH *moduleInstance =
    (InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH *)calloc(1, sizeof
    (InstanceStruct_sOaALxpPwWOVdZ1Z3G3ztH));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_sOaALxpPwWOVdZ1Z3G3ztH);
  ssSetmdlInitializeConditions(S, mdlInitialize_sOaALxpPwWOVdZ1Z3G3ztH);
  ssSetmdlUpdate(S, mdlUpdate_sOaALxpPwWOVdZ1Z3G3ztH);
  ssSetmdlDerivatives(S, mdlDerivatives_sOaALxpPwWOVdZ1Z3G3ztH);
  ssSetmdlTerminate(S, mdlTerminate_sOaALxpPwWOVdZ1Z3G3ztH);
  ssSetmdlEnable(S, mdlEnable_sOaALxpPwWOVdZ1Z3G3ztH);
  ssSetmdlDisable(S, mdlDisable_sOaALxpPwWOVdZ1Z3G3ztH);
...
static void mdlProcessParameters_sOaALxpPwWOVdZ1Z3G3ztH(SimStruct *S)
{
}

void method_dispatcher_sOaALxpPwWOVdZ1Z3G3ztH(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_sOaALxpPwWOVdZ1Z3G3ztH(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_sOaALxpPwWOVdZ1Z3G3ztH(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_sOaALxpPwWOVdZ1Z3G3ztH(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_sOaALxpPwWOVdZ1Z3G3ztH(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: sOaALxpPwWOVdZ1Z3G3ztH.\n"
...
mxArray *cgxe_sOaALxpPwWOVdZ1Z3G3ztH_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_sOaALxpPwWOVdZ1Z3G3ztH_fallback_info(void)
{
