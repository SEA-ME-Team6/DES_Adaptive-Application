#ifndef __GaAvoJiJTOAF4Sj2d9vExG_h__
#define __GaAvoJiJTOAF4Sj2d9vExG_h__
...
using s_yXNlxAMtkozv4BiPFKvBVC = tag_yXNlxAMtkozv4BiPFKvBVC;

#endif                                 /* typedef_s_yXNlxAMtkozv4BiPFKvBVC */

#ifndef struct_tag_wE3ojAPyNLljGoOmxhE8f
#define struct_tag_wE3ojAPyNLljGoOmxhE8f

struct tag_wE3ojAPyNLljGoOmxhE8f
{
...
#endif                                 /* struct_tag_wE3ojAPyNLljGoOmxhE8f */

#ifndef typedef_codertarget_raspi_internal_RaspiTCPSend
#define typedef_codertarget_raspi_internal_RaspiTCPSend

using codertarget_raspi_internal_RaspiTCPSend = tag_wE3ojAPyNLljGoOmxhE8f;

#endif                                 /* typedef_codertarget_raspi_internal_RaspiTCPSend */
...
using s_DuJTIxHyPH0sh2f3wcGFk = tag_DuJTIxHyPH0sh2f3wcGFk;
...
using cell_wrap = tag_Mq55LRTpx3F49SLl4MgJ3G;
...
using b_cell_wrap = tag_uwJsGEKtvfiUxcdf0z0AYH;
...
using c_cell_wrap = tag_hfuMxtM3511pO8GfZjii3B;
...
using d_cell_wrap = tag_L5JvjW1A13FyCQi5N783sB;
...
using cell = tag_FfLrxQ8rLS43NgaCulDHrC;
...
using b_cell = tag_Hm6EPE5ncyWd4RGCxxctzF;
...
using e_cell_wrap = tag_ge1UD3YqHcNerzgtJ4AjXF;
...
using c_cell = tag_n5V6NPhGd1s3l2q7z9eOR;
...
using d_cell = tag_VqK0uXiUXuliBvHmvcLR0F;
...
using s_oqflo8tPmhJ6sxPFLZiJGH = tag_oqflo8tPmhJ6sxPFLZiJGH;
...
using s_MY3jsqmREaTzOC09vCGedD = tag_MY3jsqmREaTzOC09vCGedD;
...
using s_r8oingdPeAlKT8PJg7lrLB = tag_r8oingdPeAlKT8PJg7lrLB;
...
using s_HOps0FrfA6RiWumqewPwZD = tag_HOps0FrfA6RiWumqewPwZD;
...
using s_URrQOsuFgHezvr1Uq6EBbB = tag_URrQOsuFgHezvr1Uq6EBbB;
...
using s_TnEayzHWuHj1hMPKnEr7h = tag_TnEayzHWuHj1hMPKnEr7h;
...
using s_lnEOVMt12CNg5nSw1iwvNF = tag_lnEOVMt12CNg5nSw1iwvNF;
...
using s_rLqvsRnn1YgNlP4UZHEHjG = tag_rLqvsRnn1YgNlP4UZHEHjG;
...
using s_HNEgOhGwwuu4IndkThqyM = tag_HNEgOhGwwuu4IndkThqyM;

#endif                                 /* typedef_s_HNEgOhGwwuu4IndkThqyM */

#ifndef typedef_InstanceStruct_GaAvoJiJTOAF4Sj2d9vExG
#define typedef_InstanceStruct_GaAvoJiJTOAF4Sj2d9vExG

struct InstanceStruct_GaAvoJiJTOAF4Sj2d9vExG
{
  SimStruct *S;
  codertarget_raspi_internal_RaspiTCPSend sysobj;
  boolean_T sysobj_not_empty;
  void *emlrtRootTLSGlobal;
  real_T *u0;
};

#endif                                 /* typedef_InstanceStruct_GaAvoJiJTOAF4Sj2d9vExG */
...
extern void method_dispatcher_GaAvoJiJTOAF4Sj2d9vExG(SimStruct *S, int_T method,
  void* data);
