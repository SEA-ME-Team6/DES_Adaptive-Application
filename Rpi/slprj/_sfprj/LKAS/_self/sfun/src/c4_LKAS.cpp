...
static emlrtRSInfo c4_jd_emlrtRSI{ 38, /* lineNo */
  "Perception Unit/MATLAB Function3",  /* fcnName */
  "#LKAS:20"                           /* pathName */
};

static emlrtRSInfo c4_kd_emlrtRSI{ 96, /* lineNo */
  "Perception Unit/MATLAB Function3",  /* fcnName */
  "#LKAS:20"                           /* pathName */
};

static emlrtRSInfo c4_md_emlrtRSI{ 101,/* lineNo */
  "Perception Unit/MATLAB Function3",  /* fcnName */
  "#LKAS:20"                           /* pathName */
};

static emlrtRSInfo c4_od_emlrtRSI{ 113,/* lineNo */
  "Perception Unit/MATLAB Function3",  /* fcnName */
  "#LKAS:20"                           /* pathName */
};

static emlrtRSInfo c4_pd_emlrtRSI{ 114,/* lineNo */
  "Perception Unit/MATLAB Function3",  /* fcnName */
  "#LKAS:20"                           /* pathName */
};
...
static emlrtRTEInfo c4_uc_emlrtRTEI{ 80,/* lineNo */
  17,                                  /* colNo */
  "Perception Unit/MATLAB Function3",  /* fName */
  "#LKAS:20"                           /* pName */
};

static emlrtRTEInfo c4_vc_emlrtRTEI{ 85,/* lineNo */
  17,                                  /* colNo */
  "Perception Unit/MATLAB Function3",  /* fName */
  "#LKAS:20"                           /* pName */
};
...
static void c4_indexShapeCheck(SFc4_LKASInstanceStruct *chartInstance);
...
static void c4_eml_find(SFc4_LKASInstanceStruct *chartInstance, const emlrtStack
  *c4_sp, boolean_T c4_b_x[900000], int32_T c4_i_data[], int32_T c4_i_size[1],
  int32_T c4_j_data[], int32_T c4_j_size[1]);
static real_T c4_mean(SFc4_LKASInstanceStruct *chartInstance, const emlrtStack
                      *c4_sp, real_T c4_x_data[], int32_T c4_x_size[1]);
static real_T c4_sumColumnB(SFc4_LKASInstanceStruct *chartInstance, const
  emlrtStack *c4_sp, real_T c4_x_data[], int32_T c4_vlen);
static real_T c4_sumColumnB4(SFc4_LKASInstanceStruct *chartInstance, real_T
  c4_x_data[], int32_T c4_vstart);
static real_T c4_b_sumColumnB(SFc4_LKASInstanceStruct *chartInstance, const
  emlrtStack *c4_sp, real_T c4_x_data[], int32_T c4_vlen, int32_T c4_vstart);
static void c4_polyfit(SFc4_LKASInstanceStruct *chartInstance, const emlrtStack *
  c4_sp, real_T c4_x_data[], int32_T c4_x_size[1], real_T c4_y_data[], int32_T
  c4_y_size[1], real_T c4_p[3]);
static void c4_qrsolve(SFc4_LKASInstanceStruct *chartInstance, const emlrtStack *
  c4_sp, real_T c4_c_A_data[], int32_T c4_b_A_size[2], real_T c4_c_B_data[],
  int32_T c4_b_B_size[1], real_T c4_m_Y[3], int32_T *c4_rankA);
static void c4_xgeqp3(SFc4_LKASInstanceStruct *chartInstance, const emlrtStack
                      *c4_sp, real_T c4_c_A_data[], int32_T c4_b_A_size[2],
                      real_T c4_d_A_data[], int32_T c4_c_A_size[2], real_T
...
static void c4_d_feval(SFc4_LKASInstanceStruct *chartInstance, const emlrtStack *
  c4_sp, const mxArray *c4_input0, const mxArray *c4_input1);
static void c4_b_xgeqp3(SFc4_LKASInstanceStruct *chartInstance, const emlrtStack
  *c4_sp, real_T c4_c_A_data[], int32_T c4_b_A_size[2], real_T c4_tau_data[],
  int32_T c4_tau_size[1], int32_T c4_jpvt[3]);
static void c4_and(SFc4_LKASInstanceStruct *chartInstance, boolean_T
...
static void c4_b_and(SFc4_LKASInstanceStruct *chartInstance, boolean_T
                     c4_b_in1_data[], int32_T c4_in1_size[1], boolean_T
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2271688759U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1596728690U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2190612090U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1716530839U);
}
...
{
  return "shCmpif7tg2D9qmpLVjIjVF";
}
...
const char* sf_c4_LKAS_get_post_codegen_info(void)
{
  ...
  const char* encStrCodegen [21] = {
    "eNrdWN2O20QUnkTbhSJYtVf0AolK3MAFUgVILRKCbp0EIrJshLNB4mY1ax/b0x2PvfOTTXgIHoA",
    "n4FF4hL4AggsuuCx3nHGcNPKG7ExSlbaWHGdsf3N+5vx8Y9LqHxE8DvC8c4eQfby+iWebzI8b9b",
    "i1cs7v75Ev6vFvbxESFTGkIEKTJGxK/A5h8iGVNFfE/xA0h+9BFdxoVoi+SAp3LBMJSBARTlAWU",
    "nvJVSw3nInznhGRlax+yFiUhVlhePwIJ6TxseCz/5JbGj1EiR0mIdI9gFhnsjBp1uM03ewFqS+D",
    "DKJzZXJvXynQoSmtqerIcM1KDt0pRH2hNEUvqGvsDTXVEOipn5OtvSpcoIu85IwKd19nVIVQYnR",
    "oOClj/D02Gr3nKBflnTFBdSEZ5d2cBxmVrtghRz2PMKy5t591rjtwZtKUidR6V5ocBNqPceLgqy",
    "QoJiBpCsfCT25kretOqwVexqUjVrMcxlQeRhgHCmK/HMQAViHFpYURTuOFBUHPOPTVSLIJrpFv3",
    "ejbVNqqbph8HklqK2wltzvBVVVbyu1FIqCcKz/sqCgHMAFeye9QTbfAzuV7gJVi8ajA6LCZ65n9",
    "RrALAzU2KETM3KNy0kBVTeI7LPgOcJbbNIAY3bxUfTnRdXlklC7yAFO/Mxg4yruK7QsNMqERONd",
    "rSZkCVLiKK0+5MVM2kRCNXtKVlc4zzHNwKyhRiRGdy0Keo499G8MzX9lM8ENDnEIHNFRFrovRPa",
    "bcOOqcK6zKNjxOFFZZP7mItfmzFTiiUQax7YGMwxHWWZzAdYmVbZ+HaO2E6VkHVCRZ6ZpJBgs6N",
    "j/rpdGshBNxLopL0ZNFHtYsZkNcAWDVoFJgK3uErVTOeqi8m9YSLkZVdfclDNbPVHN6ZmPjaxDY",
    "Da2ttnvTCLOqK5BuokK7YEP2E9IRoZjSSAFn3SoH4ooHPyDPePDeGh78xgoPvlWPo89OB98ehhX",
    "+3gr+bQceveDfm3DkCo4scYvrhyv41hq5ZOXalHezvVnPNv5r1biHK7h3GnL2Grj92ke///XzcH",
    "rwz5M/PvhofP/PX4Jd5P/a9tunHNTj9xYcaVmRJ1eKln33m2vW/93G+tuxygJM6+S+Tj/pfH6Rl",
    "4Px4/7jca+a72lrs77thr6L+3ctL8OErfJfRv243u/YMTVzHt6M1/1r/HFzJZ4I+fur3fB3H7rk",
    "y42Gv+wYpCxkI36fpx5+eLd1v92w43bF10+prcpwuqgAV/Ny2zj3xb0q8l53PZ+nfS7940XjyAv",
    "G7Wqfb1981d+/t6GOkcb7t15iOzbVUR9+9LLZ9YT48Zf36/GXy714kDEer9kN1I+RsCfrnr4m8f",
    "3U038Lvta1/qs/gP746aGgfIb0f769qm8Ppf32tnwkgar1e6z/o5+s40mufOtk1Pv4wQ596V/o7",
    "P66",
    ""
  };
...
static void mdlSetWorkWidths_c4_LKAS(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1351544037U));
  ssSetChecksum1(S,(3640200824U));
  ssSetChecksum2(S,(1445536743U));
  ssSetChecksum3(S,(1134225463U));
}
